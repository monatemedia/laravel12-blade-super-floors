<section id="why-choose-us" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <img src="/images/wooden-floors.jpg" alt="Beautiful wooden floor" class="rounded-lg shadow-xl" />
            </div>
                    ...
                    foreach ($reasons as $reason) {
                        echo '
                            <div class="flex items-center space-x-3">
                                <i class="fa-regular fa-circle-check w-6 h-6 text-green-500 flex-shrink-0 h3"></i>
